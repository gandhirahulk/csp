            ...
            try:
                ...
                if request.POST.get('o_status') != None:
                    ...
                    if len(changes_list) > 0:
                        ...
                        msg.attach_alternative(html_content, "text/html")
                        msg.send()
                        if selected_candidate.vendor_status != vendor_status.objects.get(pk = 2) or selected_candidate.vendor_status != vendor_status.objects.get(pk = 0) or selected_candidate.vendor_status != vendor_status.objects.get(pk = 3):
                            # send_mail_code
                            subject = 'Candidate Information Edited : ' + str(selected_candidate.First_Name) + ' | ' + str(selected_candidate.pk)
                            to_email = [ selected_candidate.fk_vendor_code.spoc_email_id ]
                            bcc_email = [ 'sadaf.shaikh@udaan.com' , ADMIN_MAIL ]
                            from_email = FROM_EMAIL
                            html_content = render_to_string('emailtemplates/candidate_edited_onboarding_to_vendor.html' , {'changes':changes_list, 'vendor_spoc': selected_candidate.fk_vendor_code.spoc_name, 'company_name': selected_candidate.fk_entity_code.entity_name, 'candidate_name': selected_candidate.First_Name, 'candidate_id': selected_candidate.pk, 'vendor_name': selected_candidate.fk_vendor_code.vendor_name, 'dept_name': selected_candidate.fk_department_code.department_name , 'function_name': selected_candidate.fk_function_code.function_name, 'team_name': selected_candidate.fk_team_code.team_name, 'sub_team_name': selected_candidate.fk_subteam_code.sub_team_name, 
                            'desg_name': selected_candidate.fk_designation_code.designation_name, 'city_name': selected_candidate.fk_city_code.city_name, 'region_name': selected_candidate.fk_region_code.region_name.zone_name , 'state_name': selected_candidate.fk_state_code.state_name.state_name, 'location_name': selected_candidate.fk_location_code.location_name, 'location_code': selected_candidate.fk_location_code.location_code, 'salary_num': selected_candidate.Gross_Salary_Amount , 'salary_word': num2words(selected_candidate.Gross_Salary_Amount, lang = 'en_IN'), 'rm_name': selected_candidate.Reporting_Manager, 'rm_mail': selected_candidate.Reporting_Manager_E_Mail_ID, 'doj': selected_candidate.Date_of_Joining, 'recruitment_spoc': selected_candidate.TA_Spoc_Email_Id, 'recruiter_name': recruiter_name, 'onboarding_spoc_mail': Onboarding_SPOC, 'onboarding_spoc': Onboarding_SPOC_name, 'manual_link': MANUAL_LINK, 'admin' : ADMIN_NAME, 'admin_mail': ADMIN_MAIL}) 
                            text_content = strip_tags(html_content)
                            msg = EmailMultiAlternatives(subject, text_content, from_email, to_email , bcc= bcc_email )
                            msg.attach_alternative(html_content, "text/html")
                ...
                if request.POST.get('ve_status') != None:         
                    ...
                    if len(changes_list) > 0:
                        if selected_candidate.candidate_status == candidate_status.objects.get(pk=9):
                            ...
                            bcc_email = [ 'sadaf.shaikh@udaan.com' , ADMIN_MAIL ]
                            from_email = FROM_EMAIL
                            html_content = render_to_string('emailtemplates/future_doj_confirm_vendor.html' , {'vendor_spoc': selected_candidate.fk_vendor_code.spoc_name, 'company_name': selected_candidate.fk_entity_code.entity_name, 'candidate_name': selected_candidate.First_Name, 'candidate_id': selected_candidate.pk, 'vendor_name': selected_candidate.fk_vendor_code.vendor_name, 'dept_name': selected_candidate.fk_department_code.department_name , 'function_name': selected_candidate.fk_function_code.function_name, 'team_name': selected_candidate.fk_team_code.team_name, 'sub_team_name': selected_candidate.fk_subteam_code.sub_team_name, 'region_name': selected_candidate.fk_region_code.region_name.zone_name, 'city_name': selected_candidate.fk_city_code.city_name,
                            'desg_name': selected_candidate.fk_designation_code.designation_name, 'city_name': selected_candidate.fk_city_code.city_name, 'region_name': selected_candidate.fk_region_code.region_name.zone_name , 'state_name': selected_candidate.fk_state_code.state_name.state_name, 'location_name': selected_candidate.fk_location_code.location_name, 'location_code': selected_candidate.fk_location_code.location_code, 'salary_num': selected_candidate.Gross_Salary_Amount , 'salary_word': num2words(selected_candidate.Gross_Salary_Amount, lang = 'en_IN'), 'rm_name': selected_candidate.Reporting_Manager, 'rm_mail': selected_candidate.Reporting_Manager_E_Mail_ID, 'doj': selected_candidate.Date_of_Joining, 'recruitment_spoc': selected_candidate.TA_Spoc_Email_Id, 'recruiter_name': recruiter_name, 'onboarding_spoc_mail': Onboarding_SPOC, 'onboarding_spoc': Onboarding_SPOC_name, 'manual_link': MANUAL_LINK, 'admin' : ADMIN_NAME, 'admin_mail': ADMIN_MAIL}) 
                            text_content = strip_tags(html_content)
                            msg = EmailMultiAlternatives(subject, text_content, from_email, to_email , bcc= bcc_email )
                            msg.attach_alternative(html_content, "text/html")
                            ...
                            bcc_email = [ 'sadaf.shaikh@udaan.com' , ADMIN_MAIL ]
                            from_email = FROM_EMAIL
                            html_content = render_to_string('emailtemplates/candidate_edited_vendor_onboarding.html' , {'changes':changes_list, 'vendor_spoc': selected_candidate.fk_vendor_code.spoc_name, 'company_name': selected_candidate.fk_entity_code.entity_name, 'candidate_name': str(selected_candidate.First_Name) + ' ' + str(selected_candidate.Middle_Name) + ' '+ str(selected_candidate.Last_Name) , 'candidate_id': selected_candidate.pk, 'vendor_name': selected_candidate.fk_vendor_code.vendor_name, 'dept_name': selected_candidate.fk_department_code.department_name , 'function_name': selected_candidate.fk_function_code.function_name, 'team_name': selected_candidate.fk_team_code.team_name, 'sub_team_name': selected_candidate.fk_subteam_code.sub_team_name, 
                            'desg_name': selected_candidate.fk_designation_code.designation_name, 'city_name': selected_candidate.fk_city_code.city_name, 'region_name': selected_candidate.fk_region_code.region_name.zone_name , 'state_name': selected_candidate.fk_state_code.state_name.state_name, 'location_name': selected_candidate.fk_location_code.location_name, 'location_code': selected_candidate.fk_location_code.location_code, 'salary_num': selected_candidate.Gross_Salary_Amount , 'salary_word': num2words(selected_candidate.Gross_Salary_Amount, lang = 'en_IN'), 'rm_name': selected_candidate.Reporting_Manager, 'rm_mail': selected_candidate.Reporting_Manager_E_Mail_ID, 'doj': selected_candidate.Date_of_Joining, 'recruitment_spoc': selected_candidate.TA_Spoc_Email_Id, 'recruiter_name': recruiter_name, 'onboarding_spoc_mail': Onboarding_SPOC, 'onboarding_spoc': Onboarding_SPOC_name, 'manual_link': MANUAL_LINK, 'admin' : ADMIN_NAME, 'admin_mail': ADMIN_MAIL}) 
                            text_content = strip_tags(html_content)
                            msg = EmailMultiAlternatives(subject, text_content, from_email, to_email , bcc= bcc_email )
                            msg.attach_alternative(html_content, "text/html")
                        ...
                        'desg_name': selected_candidate.fk_designation_code.designation_name, 'city_name': selected_candidate.fk_city_code.city_name, 'region_name': selected_candidate.fk_region_code.region_name.zone_name , 'state_name': selected_candidate.fk_state_code.state_name.state_name, 'location_name': selected_candidate.fk_location_code.location_name, 'location_code': selected_candidate.fk_location_code.location_code, 'salary_num': selected_candidate.Gross_Salary_Amount , 'salary_word': num2words(selected_candidate.Gross_Salary_Amount, lang = 'en_IN'), 'rm_name': selected_candidate.Reporting_Manager, 'rm_mail': selected_candidate.Reporting_Manager_E_Mail_ID, 'doj': selected_candidate.Date_of_Joining, 'recruitment_spoc': selected_candidate.TA_Spoc_Email_Id, 'recruiter_name':recruiter_name, 'onboarding_spoc_mail': Onboarding_SPOC, 'onboarding_spoc': Onboarding_SPOC_name, 'onboarding_spoc_firstname': Onboarding_SPOC_first_name, 'manual_link': MANUAL_LINK, 'admin' : ADMIN_NAME, 'admin_mail': ADMIN_MAIL}) 
                        text_content = strip_tags(html_content)
                        msg = EmailMultiAlternatives(subject, text_content, from_email, to_email , bcc= bcc_email, cc= cc_email )
                        msg.attach_alternative(html_content, "text/html")
                        msg.send() 
...
def check_for_changes(selected_candidate, firstname, middlename, lastname, doj, dob, fathername, mothername, aadhaar, Pan, contact_no, emergency_no, hiring_fk, hiring, replacement, email, subsource_fk, referral, vendor_fk, entity_fk, department_fk, function_fk, team_fk, sub_team_fk, designation_fk, region_fk, state_fk, city_fk, location_fk, reporting_manager, reporting_manager_email, gender_fk, email_creation, onboarding_spoc, la_fk, salarytype_fk, salarytype, gross_salary, ss_gross_salary,physically_challenged, request):
    ...
    if selected_candidate.fk_designation_code != designation_fk:
        changes_list['designation Code'] = [ selected_candidate.fk_designation_code, designation_fk, 'fk_designation_code' ]
    ...
    if selected_candidate.Reporting_Manager != reporting_manager:
        changes_list['Reporting Manager'] = [ selected_candidate.Reporting_Manager, reporting_manager, 'Reporting_Manager' ]
    ...
    if selected_candidate.Reporting_Manager_E_Mail_ID != reporting_manager_email:
        changes_list['Reporting Manager E Mail ID'] = [ selected_candidate.Reporting_Manager_E_Mail_ID, reporting_manager_email , 'Reporting_Manager_E_Mail_ID']
    ...
    if selected_candidate.E_Mail_ID_Creation != email_creation:
        changes_list['E Mail ID Creation'] = [ selected_candidate.E_Mail_ID_Creation, email_creation, 'E_Mail_ID_Creation' ]
    selected_candidate.E_Mail_ID_Creation= email_creation
    
    if selected_candidate.physically_challenged != physically_challenged:
        changes_list['Physically Challenged'] = [ selected_candidate.physically_challenged, physically_challenged, 'physically_challenged' ]
    ...
    if selected_candidate.Onboarding_Spoc_Email_Id != onboarding_spoc:
        changes_list['Onboarding Spoc Email Id'] = [ selected_candidate.Onboarding_Spoc_Email_Id, onboarding_spoc, 'Onboarding_Spoc_Email_Id' ]
    ...
    if x != y:
        changes_list['Gross Salary Amount'] = [ selected_candidate.Gross_Salary_Amount, gross_salary, 'Gross_Salary_Amount' ]
        s_amount = 1
        ...
        if request.method == 'POST':
            ...
            for eachgroup in request.user.groups.all():
                if str(eachgroup) == 'Admin':
                    ...
                    bcc_email = [ 'sadaf.shaikh@udaan.com' , ADMIN_MAIL ]
                    from_email = FROM_EMAIL
                    html_content = render_to_string('emailtemplates/candidate_rejected_onboarding.html' , {'onboarding_spoc': Onboarding_SPOC_first_name, 'company_name': selected_candidate.fk_entity_code.entity_name, 'candidate_name': selected_candidate.First_Name, 'candidate_id': selected_candidate.pk, 'vendor_name': selected_candidate.fk_vendor_code.vendor_name, 'dept_name': selected_candidate.fk_department_code.department_name, 'function_name': selected_candidate.fk_function_code.function_name, 'team_name': selected_candidate.fk_team_code.team_name, 'sub_team_name': selected_candidate.fk_subteam_code.sub_team_name, 
                    'desg_name': selected_candidate.fk_designation_code.designation_name, 'reason': reason , 'state_name': selected_candidate.fk_state_code.state_name.state_name, 'location_name': selected_candidate.fk_location_code.location_name, 'location_code': selected_candidate.fk_location_code.location_code, 'salary_num': selected_candidate.Gross_Salary_Amount, 'salary_word': num2words(selected_candidate.Gross_Salary_Amount, lang = 'en_IN'), 'rm_name': selected_candidate.Reporting_Manager, 'rm_mail': selected_candidate.Reporting_Manager_E_Mail_ID, 'doj': selected_candidate.Date_of_Joining, 'recruitment_spoc': selected_candidate.TA_Spoc_Email_Id,'recruiter_name': recruiter_name, 'manual_link': MANUAL_LINK, 'admin' : ADMIN_NAME, 'admin_mail': ADMIN_MAIL}) 
                    ...
                    bcc_email = [ 'sadaf.shaikh@udaan.com' , ADMIN_MAIL ]
                    from_email = FROM_EMAIL
                    html_content = render_to_string('emailtemplates/candidate_rejected_vendor.html' , {'onboarding_spoc': Onboarding_SPOC_first_name, 'company_name': selected_candidate.fk_entity_code.entity_name, 'candidate_name': selected_candidate.First_Name, 'candidate_id': selected_candidate.pk, 'vendor_name': selected_candidate.fk_vendor_code.vendor_name, 'dept_name': selected_candidate.fk_department_code.department_name, 'function_name': selected_candidate.fk_function_code.function_name, 'team_name': selected_candidate.fk_team_code.team_name, 'sub_team_name': selected_candidate.fk_subteam_code.sub_team_name, 
                    'desg_name': selected_candidate.fk_designation_code.designation_name, 'reason': reason , 'state_name': selected_candidate.fk_state_code.state_name.state_name, 'location_name': selected_candidate.fk_location_code.location_name, 'location_code': selected_candidate.fk_location_code.location_code, 'salary_num': selected_candidate.Gross_Salary_Amount, 'salary_word': num2words(selected_candidate.Gross_Salary_Amount, lang = 'en_IN'), 'rm_name': selected_candidate.Reporting_Manager, 'rm_mail': selected_candidate.Reporting_Manager_E_Mail_ID, 'doj': selected_candidate.Date_of_Joining, 'recruitment_spoc': selected_candidate.TA_Spoc_Email_Id, 'recruiter_name': recruiter_name, 'manual_link': MANUAL_LINK, 'admin' : ADMIN_NAME, 'admin_mail': ADMIN_MAIL}) 
                    ...
                    bcc_email = [ 'sadaf.shaikh@udaan.com' , ADMIN_MAIL ]
                    from_email = FROM_EMAIL
                    html_content = render_to_string('emailtemplates/candidate_rejected_vendor_manager.html' , {'onboarding_spoc': Onboarding_SPOC_first_name, 'company_name': selected_candidate.fk_entity_code.entity_name, 'candidate_name': selected_candidate.First_Name, 'candidate_id': selected_candidate.pk, 'vendor_name': selected_candidate.fk_vendor_code.vendor_name, 'dept_name': selected_candidate.fk_department_code.department_name, 'function_name': selected_candidate.fk_function_code.function_name, 'team_name': selected_candidate.fk_team_code.team_name, 'sub_team_name': selected_candidate.fk_subteam_code.sub_team_name, 
                    'desg_name': selected_candidate.fk_designation_code.designation_name, 'reason': reason , 'state_name': selected_candidate.fk_state_code.state_name.state_name, 'location_name': selected_candidate.fk_location_code.location_name, 'location_code': selected_candidate.fk_location_code.location_code, 'salary_num': selected_candidate.Gross_Salary_Amount, 'salary_word': num2words(selected_candidate.Gross_Salary_Amount, lang = 'en_IN'), 'rm_name': selected_candidate.Reporting_Manager, 'rm_mail': selected_candidate.Reporting_Manager_E_Mail_ID, 'doj': selected_candidate.Date_of_Joining, 'recruitment_spoc': selected_candidate.TA_Spoc_Email_Id, 'recruiter_name': recruiter_name, 'manual_link': MANUAL_LINK, 'admin' : ADMIN_NAME, 'admin_mail': ADMIN_MAIL}) 
...
def future_joining_requests(request):
    ...
    if request.method == 'POST':
        ...
        if reject == None and confirm != None:
            ...
            html_content = render_to_string('emailtemplates/future_doj_confirm_onboarding_to_manager.html' , {'onboarding_spoc': Onboarding_SPOC_first_name, 'company_name': selected_candidate.fk_entity_code.entity_name, 'candidate_name': selected_candidate.First_Name, 'candidate_id': selected_candidate.pk, 'vendor_name': selected_candidate.fk_vendor_code.vendor_name, 'dept_name': selected_candidate.fk_department_code.department_name, 'function_name': selected_candidate.fk_function_code.function_name, 'team_name': selected_candidate.fk_team_code.team_name, 'sub_team_name': selected_candidate.fk_subteam_code.sub_team_name, 'onboarding_spoc_mail' : selected_candidate.Onboarding_Spoc_Email_Id,'region_name': selected_candidate.fk_region_code.region_name.zone_name, 'city_name': selected_candidate.fk_city_code.city_name,
    ...
    try:
        ...
        if request.method == 'POST':
            ...
            try:
                ...
                new_code = create_dummy(firstname, middlename, lastname, doj, dob, fathername, mothername, aadhaar, Pan, contact_no, emergency_no, hiring_fk, replacement, email, subsource_fk, referral, vendor_fk, entity_fk, department_fk, function_fk, team_fk, sub_team_fk, designation_fk, region_fk, state_fk, city_fk, location_fk, selected_c.Gross_Salary_Entered, reporting_manager, reporting_manager_email, gender_fk, email_creation, ta_spoc, onboarding_spoc, la_fk, salarytype_fk, gross_salary, request, physically_challenged)
    ...
    try:
        if request.method == 'POST':
            ...
            try:
                ...
                new_code = create_dummy(firstname, middlename, lastname, doj, dob, fathername, mothername, aadhaar, Pan, contact_no, emergency_no, hiring_fk, replacement, email, subsource_fk, referral, vendor_fk, entity_fk, department_fk, function_fk, team_fk, sub_team_fk, designation_fk, region_fk, state_fk, city_fk, location_fk, loc_code, reporting_manager, reporting_manager_email, gender_fk, email_creation, ta_spoc, onboarding_spoc, la_fk, salarytype_fk, gross_salary, request, physically_challenged)
                dummy = dummy_candidate.objects.get(pk=new_code)
                minimum_wage = ''
                            #monthly
                try:
...
def update_selected_candidate(cid, firstname, middlename, lastname, doj, dob, fathername, mothername, aadhaar, Pan, contact_no, emergency_no, hiring_fk, replacement, subsource_fk, referral, vendor_fk, entity_fk, department_fk, function_fk, team_fk, sub_team_fk, designation_fk, region_fk, state_fk, city_fk, location_fk, loc_code, reporting_manager, reporting_manager_email, gender_fk, email_creation, onboarding_spoc, la_fk, salarytype_fk, request, email, gs, physically_challenged):
    selected_candidate = master_candidate.objects.get(pk = cid)
    selected_candidate.First_Name=firstname
    selected_candidate.Middle_Name=middlename
    selected_candidate.Last_Name= lastname
...
def create_dummy(firstname, middlename, lastname, doj, dob, fathername, mothername, aadhaar, Pan, contact_no, emergency_no, hiring_fk, replacement, email, subsource_fk, referral, vendor_fk, entity_fk, department_fk, function_fk, team_fk, sub_team_fk, designation_fk, region_fk, state_fk, city_fk, location_fk, loc_code, reporting_manager, reporting_manager_email, gender_fk, email_creation, ta_spoc, onboarding_spoc, la_fk, salarytype_fk, gross_salary, request, physically_challenged):
    ...
    Laptop_Allocation= la_fk, Salary_Type= salarytype_fk, Gross_Salary_Amount= float(gross_salary), created_by = str(request.user), candidate_status=pending_status, created_date_time= datetime.now(), physically_challenged=physically_challenged)
    ...
    try:
        ...
        if request.method == 'POST':
            ...
            try:
                ...
                fk_team_code= team_fk, fk_subteam_code= sub_team_fk, fk_designation_code= designation_fk, fk_region_code= region_fk, fk_state_code= state_fk, fk_city_code= city_fk, fk_location_code= location_fk, Gross_Salary_Entered= loc_code,
                Reporting_Manager= reporting_manager , Reporting_Manager_E_Mail_ID= reporting_manager_email, Gender= gender_fk, E_Mail_ID_Creation= email_creation, TA_Spoc_Email_Id= ta_spoc, Onboarding_Spoc_Email_Id= Onboarding_SPOC,
                Laptop_Allocation= la_fk, Salary_Type= salarytype_fk, Gross_Salary_Amount= INR_to_number(ss_gross_salary), created_by = str(request.user), candidate_status=pending_status, created_date_time= datetime.now(), laptop_status= laptop_request, email_creation_status= email_request, physically_challenged=physically_challenged)
                new_candidate.save()
                ...
                'desg_name': designation_fk.designation_name, 'region_name': region_fk.region_name.zone_name , 'state_name': state_fk.state_name.state_name, 'city_name': city_fk.city_name, 'location_name': location_fk.location_name, 'location_code': location_fk.location_code, 'salary_num': gross_salary, 'salary_word': num2words(gross_salary, lang = 'en_IN'), 'rm_name': reporting_manager, 'rm_mail': reporting_manager_email, 'doj': doj, 'recruitment_spoc': str(request.user.email), 'recruiter_name': recruiter_name, 'manual_link': MANUAL_LINK, 'admin' : ADMIN_NAME, 'admin_mail': ADMIN_MAIL}) 
        ...
        if request.method == 'POST':
            ...
            try:
                ...
                if flag == 1 and candidate_fk.offer_letter_status.pk == 1:
                    ...
                    'desg_name': selected_candidate.fk_designation_code.designation_name,'city_name': selected_candidate.fk_city_code.city_name, 'city_name': selected_candidate.fk_city_code.city_name, 'region_name': selected_candidate.fk_region_code.region_name.zone_name , 'state_name': selected_candidate.fk_state_code.state_name.state_name, 'location_name': selected_candidate.fk_location_code.location_name, 'location_code': selected_candidate.fk_location_code.location_code, 'salary_num': selected_candidate.Gross_Salary_Amount , 'salary_word': num2words(selected_candidate.Gross_Salary_Amount, lang = 'en_IN'), 'rm_name': selected_candidate.Reporting_Manager, 'rm_mail': selected_candidate.Reporting_Manager_E_Mail_ID, 'doj': selected_candidate.Date_of_Joining, 'recruitment_spoc': selected_candidate.TA_Spoc_Email_Id,'recruiter_name': recruiter_name, 'onboarding_spoc_mail': Onboarding_SPOC, 'onboarding_spoc': Onboarding_SPOC_name, 'manual_link': MANUAL_LINK, 'admin' : ADMIN_NAME, 'admin_mail': ADMIN_MAIL}) 
                    text_content = strip_tags(html_content)
                    msg = EmailMultiAlternatives(subject, text_content, from_email, to_email , bcc= bcc_email, cc= cc_email )
                    msg.attach_alternative(html_content, "text/html")
                    msg.send()
...
def create_vendor(request):  
    ...
    if request.method == 'POST':
        ...
        try:      
            ...
            bcc_email = [ 'sadaf.shaikh@udaan.com' , ADMIN_MAIL ]
            from_email = FROM_EMAIL
            html_content = render_to_string('emailtemplates/new_vendor_account_first.html' , {'vendor_spoc': vendor_spoc,'company_name': entity_fk.entity_name, 'vendor_email': vendor_email, 'onboarding_spoc_mail': Onboarding_SPOC, 'onboarding_spoc': Onboarding_SPOC_name, 'username': vendor_spoc_email, 'password': password, 'manual_link': MANUAL_LINK, 'admin' : ADMIN_NAME, 'admin_mail': ADMIN_MAIL}) 
            text_content = strip_tags(html_content)
            msg = EmailMultiAlternatives(subject, text_content, from_email, to_email , bcc= bcc_email)
            msg.attach_alternative(html_content, "text/html")
            msg.send()   
...
def  create_function(request):
    if request.method == 'POST':
        ...
        try:
            ...
            new_function = master_function( function_name= function_name ,fk_entity_code= department_fk.fk_entity_code, fk_department_code= department_fk, created_by = str(request.user), created_date_time= datetime.now())
            new_function.save()
...
def  create_team(request):
    if request.method == 'POST':
        ...
        try:
            ...
            new_team = master_team( team_name= team_name ,fk_entity_code=function_fk.fk_entity_code, fk_department_code=function_fk.fk_department_code,  fk_function_code=function_fk, created_by = str(request.user), created_date_time= datetime.now())
            new_team.save()
...
def  create_subteam(request):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            new_subteam = master_sub_team( sub_team_name= subteam_name,fk_entity_code=team_fk.fk_entity_code, fk_department_code=team_fk.fk_department_code, fk_function_code=team_fk.fk_function_code , fk_team_code=team_fk, created_by = str(request.user), created_date_time= datetime.now())
            new_subteam.save()
...
def  create_designation(request):
    if request.method == 'POST':
        ...
        try:
            ...
            new_designation = master_designation( designation_name= designation_name, fk_entity_code=subteam_fk.fk_entity_code, fk_department_code=subteam_fk.fk_department_code, fk_function_code=subteam_fk.fk_function_code , fk_team_code=subteam_fk.fk_team_code, fk_sub_team_code=subteam_fk, fk_skill_code= skill_fk, created_by = str(request.user), created_date_time= datetime.now())
...
def  create_state(request):
    if request.method == 'POST':
        ...
        try:
            ...
            new_state = master_state( state_name= state_name , fk_entity_code= region_fk.fk_entity_code, fk_region_code =region_fk, created_by = str(request.user), created_date_time= datetime.now())
            new_state.save()
...
def  create_city(request):
    if request.method == 'POST':
        ...
        try:
            ...
            new_city = master_city( city_name= city_name , fk_entity_code= state_fk.fk_entity_code, fk_region_code= state_fk.fk_region_code, fk_state_code =state_fk, created_by = str(request.user), created_date_time= datetime.now())
            new_city.save()
...
def  create_location(request):
    if request.method == 'POST':
        ...
        try:
            ...
            new_location = master_location( location_name= location_name , fk_entity_code=city_fk.fk_entity_code, fk_region_code= city_fk.fk_region_code, fk_state_code= city_fk.fk_state_code, location_code=code, fk_city_code =city_fk, created_by = str(request.user), created_date_time= datetime.now())
            new_location.save()
