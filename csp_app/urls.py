...
urlpatterns = [
                  ...
                  path('reporting_manager/joining_confirmation/', reporting_manager.joining_confirmation,
                       name='rm_joining_confirmation'),
                  ...
                  path('csp_minimum_wages/save_edit_minimum_wages/', views.save_edit_wages,
                       name='save_edit_minimumwages'),
                  ...
                  path('csp_candidates/view_edit_candidate/<str:cid>/', views.view_edit_candidate,
                       name='view_edit_candidate'),
                  path('csp_candidates/edit_candidate_salary/', views.edit_salary_structure,
                       name='edit_salary_structure'),
                  ...
                  path('csp_candidates/check_duplicacy_new/', views.check_duplicate_candidate_new,
                       name='check_duplicate_candidate_new'),
                  path('csp_candidates/check_duplicacy_edit/', views.check_duplicate_candidate_edit,
                       name='check_duplicate_candidate_edit'),
                  ...
                  path('csp_candidates/vendor_change_status/', views.change_candidate_status_vendor,
                       name='change_candidate_status_vendor'),

                  path('csp_candidates/document_upload/<str:candidate_id>/', views.candidate_document_upload,
                  ...
                  path('csp_candidates/future_joining_requests/', views.future_joining_requests,
                       name='future_joining_request'),

                  path('csp_candidates/process_requests/<str:cid>/', views.process_requests, name='process_request'),
                  path('csp_candidates/process_requests/reject_request/<str:cid>/', views.reject_candidate_vendor,
                       name='reject_candidate_vendor'),

                  path('csp_candidates/process_requests/reject_request/<str:cid>/', views.reject_candidate_onboarding,
                       name='reject_candidate_onboarding'),
                  path('csp_candidates/process_requests/salary_structure/<str:cid>/',
                       views.edit_salary_structure_process, name='edit_salary_structure_process'),
                  # ajax
                  ...
                  path('csp_designation/save_edit_designation/', views.save_edit_designation,
                       name='save_edit_designation'),
