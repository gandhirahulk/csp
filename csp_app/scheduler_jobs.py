...
from csp_app.models import master_candidate, master_vendor, vendor_status, onboarding_status
...
def RemindVendor():
    ...
    pending_action_candidates = master_candidate.objects.filter(vendor_status=pending, onboarding_status= approve)
